...
#ifndef FW_ESP32_MQTT_H_
#define FW_ESP32_MQTT_H_
#include <stdbool.h>
 ...
 */
esp_mqtt_client_handle_t fw_esp32_mqtt_start_client(char *uri);
 ...
 *	- false in case an error occurs
 */
bool fw_esp32_mqtt_close_client(esp_mqtt_client_handle_t client);
 ...
 *	- false in case an error occurs
 */
bool fw_esp32_mqtt_client_subscribe(esp_mqtt_client_handle_t client, const char *topic, int qos);
 ...
 *	- false in case an error occurs 
 */
bool fw_esp32_mqtt_client_unsubscribe(esp_mqtt_client_handle_t client, const char *topic);
 ...
 */
int fw_esp32_mqtt_client_publish(esp_mqtt_client_handle_t client, const char *topic, const char *data, int len, int qos);
